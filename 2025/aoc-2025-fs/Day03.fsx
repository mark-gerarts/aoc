...
let banks = "input/03.txt" |> System.IO.File.ReadLines |> Seq.map parseLine
...
banks |> Seq.sumBy (maxJoltage 2) |> printfn "Part 1: %i"
banks |> Seq.sumBy (maxJoltage 12) |> printfn "Part 2: %i"
