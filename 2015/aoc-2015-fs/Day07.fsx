...
// This recursively updates wires. It's fast enough, but could alternatively
// topologically sort the wires and calculate the values in one pass.
let rec calculateSignals instructions knownValues =
    ...
    let newKnown = Seq.fold updateIfKnown knownValues instructions
...
let instructions =
    System.IO.File.ReadLines "input/07.txt" |> Seq.map parseLine |> Seq.toList
